...
document.getElementById('quiz-form').addEventListener('submit', function(event) {
    ...
    const respuestasCorrectas = {
        pregunta1: 'Adaptarse rápidamente a la situación, posponer las tareas no urgentes y abordar la entrega de productos de manera eficiente',
        pregunta2: 'Pera',
        pregunta3: 'No eres lo que logras, eres lo que superas',
        pregunta4: 'Consideras implementar un programa de limpieza más estructurado, asignar horarios específicos para la limpieza profunda del centro de acopio, o proporcionar incentivos para que los vendedores mantengan sus espacios ordenado'
    };
