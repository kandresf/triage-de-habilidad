...
document.getElementById('quiz-form').addEventListener('submit', function(event) {
    ...
    const respuestasCorrectas = {
        pregunta1: 'Reflexionar sobre las estrategias de trabajo y considerar posibles mejoras',
        pregunta2: 'Piña',
        pregunta3: 'Si tocas fondo úsalo para impulsarte',
        pregunta4: 'Revisar la organización del espacio y considerar mejoras como reorganizar los puestos de venta o implementar señalizaciones claras'
    };
    ...
    if (puntaje === 4) {
        ...
        color = ['#FFFF00', '#FFFF00', '#FFFF00', '#FFFF00']; // Amarillo
