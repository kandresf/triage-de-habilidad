...
document.getElementById('quiz-form').addEventListener('submit', function(event) {
    ...
    const respuestasCorrectas = {
        pregunta1: 'Decides implementar descuentos especiales o promociones por volumen de compra para atraer a más clientes y fomentar ventas adicionales',
        pregunta2: 'Mora',
        pregunta3: 'Un fuerte abrazo rompe los miedos',
        pregunta4: 'Decides organizar talleres regulares donde los vendedores aprendan sobre técnicas de almacenamiento adecuado, rotación de inventario y métodos para reducir el desperdicio de alimentos'
    };
