...
document.getElementById('quiz-form').addEventListener('submit', function(event) {
    ...
    const respuestasCorrectas = {
        pregunta1: 'Escuchas atentamente al proveedor, mostrando empatía por su preocupación y prometiendo investigar la situación para encontrar una solución',
        pregunta2: 'Falso: En un ambiente laboral colaborativo como un centro de acopio, es importante mostrar empatía y escuchar las preocupaciones de todos los colegas para mantener un equipo cohesionado y eficiente',
        pregunta3: 'Te acercas al empleado en privado, muestras empatía por las dificultades que pueda estar enfrentando, y le ofreces orientación y apoyo para mejorar su desempeño',
        pregunta4: 'Verdadero: La comunicación asertiva y la empatía son herramientas clave para manejar conflictos de manera efectiva, promoviendo un ambiente de trabajo armonioso y productivo en la plaza de mercado'
    };
