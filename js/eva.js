...
document.getElementById('quiz-form').addEventListener('submit', function(event) {
    ...
    const respuestasCorrectas = {
        pregunta1: 'Escuchar atentamente las preocupaciones del cliente, disculparse por la experiencia negativa y ofrecer un reembolso o un reemplazo del producto',
        pregunta2: 'Uva',
        pregunta3: 'corazón se nutre de palabras y actos sinceros',
        pregunta4: 'Observar el flujo de clientes y ajustar progresivamente, modificando la disposición de los productos agrícolas según la forma en que los clientes navegan por el puesto'
    };
